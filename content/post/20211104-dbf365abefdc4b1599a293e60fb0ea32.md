...
NOTION_METADATA:
  object: "page"
  id: "dbf365ab-efdc-4b15-99a2-93e60fb0ea32"
    ...
    Name:
      ...
      title:
        - type: "text"
          ...
          plain_text: "20211104"
          href: null
  url: "https://www.notion.so/20211104-dbf365abefdc4b1599a293e60fb0ea32"
UPDATE_TIME: "2023-05-28T05:33:37.588Z"
...
VMからLXCコンテナに変更。データは * /var/lib/elasticsearch * /etc/elasticsearch をそのまま転送したらあっけなく動いた。が。javaがcgroupのメモリ量制限に 対応しないというかオプションつけないと対応しないので、 `jvm.options`で `-mx3500m` を追加してメモリを制限した。 (これをしないとホストのメモリ量からヒープの量を計算してしまいOOMする)
